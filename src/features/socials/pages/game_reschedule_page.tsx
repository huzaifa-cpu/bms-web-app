...
import { z } from 'zod'
import { Card, Form, Button, InputGroup, ListGroup, Row, Col, Dropdown, Spinner, Alert } from 'react-bootstrap'
...
export default function GameReschedulePage() {
  ...
  return (
    <div>
      <h4 className="fw-bold mb-4">Reschedule Game — {game.title}</h4>
      <Alert variant="info" className="mb-4">
        This game was previously cancelled. Select a new date and time to reschedule it.
      </Alert>
        ...
        <Card.Body>
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Row>
              <Col md={4}>
                <Form.Group className="mb-3">
                  <Form.Label>New Game Date <span className="text-danger">*</span></Form.Label>
            ...
            <div className="d-flex gap-2">
              <Button type="submit" variant="success" disabled={isRescheduling}>{isRescheduling ? 'Rescheduling...' : 'Reschedule Game'}</Button>
