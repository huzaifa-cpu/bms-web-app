...
import { useListGameFormatsQuery, useCreateGameMutation } from '../api/socials_api'
...
export default function GameCreatePage() {
  ...
  const { data: locationsData, isLoading: locationsLoading } = useListLocationsQuery({ approvalState: ['APPROVED'], size: 100 })
  ...
  return (
    <div>
      <h4 className="fw-bold mb-4">Create Game</h4>
      <Card className="shadow-sm" style={{ maxWidth: 700 }}>
        <Card.Body>
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Form.Group className="mb-3">
              <Form.Label>Game Title <span className="text-danger">*</span></Form.Label>
              <Form.Control isInvalid={!!errors.title} {...register('title')} placeholder="e.g., Sunday Cricket Match" />
            ...
            <Form.Group className="mb-3">
              ...
              {selectedOrganizer ? (
                ...
                <div className="position-relative">
                  ...
                  {showOrganizerResults && organizerSearch.length >= 3 && !consumersLoading && consumers.length === 0 && (
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control as="textarea" rows={2} {...register('description')} placeholder="Add game description..." />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Rules</Form.Label>
              <Form.Control as="textarea" rows={2} {...register('rules')} placeholder="Add game rules..." />
            </Form.Group>

            <div className="d-flex gap-2">
              <Button type="submit" variant="primary" disabled={isCreating}>{isCreating ? 'Creating...' : 'Create Game'}</Button>
